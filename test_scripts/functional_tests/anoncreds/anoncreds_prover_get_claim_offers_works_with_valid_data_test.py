...
class TestProverGetClaimOffersWithValidData(AnoncredsTestBase):
    ...
    async def test(self):
        ...
        offer_json2 = await anoncreds.issuer_create_claim_offer(self.wallet_handle, json.dumps(constant.gvt_schema),
        ...
        utils.check(self.steps, error_message="Cannot store a claim offer",
                    ...
                    constant.gvt_schema_key == list_claim_offer[1]['schema_key'])
